...
<template>
  <div class="max-w-xl mx-auto mb-12 p-6">
    <div @dragover="dragover" @dragleave="dragleave" @drop="drop"
         class="flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md bg-gray-100">
